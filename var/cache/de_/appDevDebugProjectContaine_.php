...
class appDevDebugProjectContaine_ extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VALZNEYKdk', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xA+yiQi+Ne', 0, 'Eovd5kg7y6uHhGx1fJUWVH', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'coresphere_console.application' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\FrameworkBundle\Console\Application A Symfony\Bundle\FrameworkBundle\Console\Application instance
     */
    protected function getCoresphereConsole_ApplicationService()
    {
        return $this->services['coresphere_console.application'] = $this->get('coresphere_console.application.factory')->create($this->get('kernel'));
    }

    /**
     * Gets the 'coresphere_console.application.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreSphere\ConsoleBundle\Console\ApplicationFactory A CoreSphere\ConsoleBundle\Console\ApplicationFactory instance
     */
    ...
    /**
     * Gets the 'coresphere_console.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreSphere\ConsoleBundle\Controller\ConsoleController A CoreSphere\ConsoleBundle\Controller\ConsoleController instance
     */
    protected function getCoresphereConsole_ControllerService()
    {
        return $this->services['coresphere_console.controller'] = new \CoreSphere\ConsoleBundle\Controller\ConsoleController($this->get('templating'), $this->get('coresphere_console.executer'), $this->get('coresphere_console.application'), 'dev');
    }

    /**
     * Gets the 'coresphere_console.executer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreSphere\ConsoleBundle\Executer\CommandExecuter A CoreSphere\ConsoleBundle\Executer\CommandExecuter instance
     */
    protected function getCoresphereConsole_ExecuterService()
    {
        return $this->services['coresphere_console.executer'] = new \CoreSphere\ConsoleBundle\Executer\CommandExecuter($this->get('kernel'));
    }

    /**
     * Gets the 'coresphere_console.routing' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreSphere\ConsoleBundle\Routing\Loader A CoreSphere\ConsoleBundle\Routing\Loader instance
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'hostinger_moueza_symfony', 'user' => 'root', 'password' => 'hem7pton', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5a7469fd75a902f600e3699230b97e86f6b17852441861264e3231ea709888a0');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('5wdSqAv44Q', NULL, 'Eovd5kg7y6uHhGx1fJUWVH', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $d->addLoader($c);
        $d->addLoader($this->get('coresphere_console.routing'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'OC\\UserBundle\\Entity\\Inscrit' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/inscrits'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1d9ee31768e365a7ed865e7a0246e07a7f6e2935');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b1H--lATnH', 0, 'Eovd5kg7y6uHhGx1fJUWVH', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['routing.loader.yml'] = new \Symfony\Component\Routing\Loader\YamlFileLoader($this->get('file_locator'));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'OC\\UserBundle\\Entity\\Inscrit', 'pseudo', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'hostinger_moueza_symfony',
            'database_user' => 'root',
            'database_password' => 'hem7pton',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '1d9ee31768e365a7ed865e7a0246e07a7f6e2935',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1d9ee31768e365a7ed865e7a0246e07a7f6e2935',
